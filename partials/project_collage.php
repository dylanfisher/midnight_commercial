<?php $title_position = get_field( 'title_position' ) == 'left' ? '' : 'col-xs-offset-4 col-sm-offset-6' ?>
<div class="project-collage">
  <div class="row">
    <div class="project-collage__title-area project-collage__title-area--<?php the_field( 'title_position' ); ?> col-xs-8 col-sm-4 <?php echo $title_position; ?>">
      <h2>
